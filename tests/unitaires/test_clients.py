...
class TestClient(TestSetUp):
    ...
    def test_CRUD_for_client_for_sales_contact(self):
        ...
        expected = [
            {
                'id': 4, 'first_name': 'client_1', 'last_name': 'client_1', 'email': 'client_1@test.com', 
            ...
            }, {'id': 5, 'first_name': 'client_2', 'last_name': 'client_2', 'email': 'client_2@test.com', 
        ...
        response1 = self.client.post('/clients/', data=
            {
        ...
        response6 = self.client.post('/clients/', data=
            {
                'first_name': 'new_client', 'last_name': 'new_client', 'email': 'new_client@test.com', 
                'phone': '1023456789', 'mobile': '', 'company_name': 'company12', 
                'existing': False,
            }
        )
